...
import countryListAllIsoDataType from '../constants/types/countryListAllIsoDataType';
interface State {
  countryListAllIsoData: countryListAllIsoDataType[];
  allState: string[];
}

export const covidTracker = defineStore('covidTracker', {
  state: (): State => ({
    countryListAllIsoData: [
      ...
      { code: 'FK', code3: 'FLK', name: 'Falkland Islands (the) [Malvinas]' },
      { code: 'FO', code3: 'FRO', name: 'Faroe Islands (the)' },
      ...
      { code: 'TF', code3: 'ATF', name: 'French Southern Territories (the)' },
      ...
      { code: 'VA', code3: 'VAT', name: 'Holy See (the)' },
      ...
      { code: 'KR', code3: 'KOR', name: 'Korea (the Republic of)' },
      ...
      { code: 'MH', code3: 'MHL', name: 'Marshall Islands (the)' },
      ...
      { code: 'MD', code3: 'MDA', name: 'Moldova (the Republic of)' },
      ...
      { code: 'PH', code3: 'PHL', name: 'Philippines (the)' },
      ...
      { code: 'MK', code3: 'MKD', name: 'Republic of North Macedonia' },
      { code: 'RO', code3: 'ROU', name: 'Romania' },
      { code: 'RU', code3: 'RUS', name: 'Russian Federation (the)' },
      ...
      { code: 'SD', code3: 'SDN', name: 'Sudan (the)' },
      ...
      { code: 'TC', code3: 'TCA', name: 'Turks and Caicos Islands (the)' },
      { code: 'TV', code3: 'TUV', name: 'Tuvalu' },
      { code: 'UG', code3: 'UGA', name: 'Uganda' },
      { code: 'UA', code3: 'UKR', name: 'Ukraine' },
      { code: 'AE', code3: 'ARE', name: 'United Arab Emirates (the)' },
      {
        code: 'GB',
        code3: 'GBR',
      ...
      { code: 'US', code3: 'USA', name: 'United States of America (the)' },
